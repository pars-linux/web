...
str+='        .tub-menuBack{';
str+='            width:100%;';
str+='            background-color:#333;';
str+='            background-image:url('+tadres+'back.jpg);';
str+='            font-family:verdana;';
str+='            font-size:9px;';
str+='            color:#fff;';
str+='        }';
str+='        .tub-menuBack img{';
str+='            border:0px;';
str+='        }';
str+='        .tub-menu{';
...
str+='        }';
str+='		#altserit, #altserit a{ ';
str+='			font-family: verdana; ';
str+='			font-size:9px; ';
str+='			color:white; ';
str+='		} ';
str+='		#alt_tablo{ ';
str+='			width: '+tub_opener_genislik+'; ';
str+='		} ';
str+='    <\/style>';
str+='    <div class="tub-menuBack">';
str+='        <div class="tub-menu">';
str+='            <div id="tub-opener">';
str+='                <div class="tub-openerSol"><a href="http:\/\/uekae.tubitak.gov.tr\/" target="_blank">UEKAE<\/a><\/div><div class="tub-openerSag"><a href="http:\/\/www.uekae.tubitak.gov.tr\/contact.do?ot=7">İletişim \/ Bilgi Edinme<\/a> | <a href="http:\/\/www.uekae.tubitak.gov.tr\/help.do?ot=8">Yardım<\/a> | <a href="http:\/\/www.uekae.tubitak.gov.tr\/sitemap.do?ot=9">Site Haritası<\/a> | <a href="http:\/\/www.uekae.tubitak.gov.tr\/home.do?ot=10<=en" class="aHeader">English<\/a><\/div>';
str+='            <\/div>';
str+='            <div style="clear:both"><\/div>';
str+='            <div id="tub-icerik-gizler">';
str+='                <div id="tub-icerik">';
str+='                    <span><a href="http:\/\/uekae.tubitak.gov.tr" title="TÜBİTAK UEKAE"><img src="'+tadres+'tubbar_01.jpg" onmouseout="outMouse(this)" onmouseover="onMouse(this)" \/><\/a><\/span><span><a href="http:\/\/www.akiskart.com.tr" title="Akıllı Kart İşletim Sistemi"><img src="'+tadres+'tubbar_02.jpg" onmouseout="outMouse(this)" onmouseover="onMouse(this)" \/><\/a><\/span><span><a href="http:\/\/www.kamusm.gov.tr" title="Kamu SM, Elektronik Sertifika Hizmetleri ve E-imza Çözümleri"><img src="'+tadres+'tubbar_04.jpg" onmouseout="outMouse(this)" onmouseover="onMouse(this)"  \/><\/a><\/span><span><a href="http:\/\/www.pardus.org.tr" title="TÜBİTAK UEKAE Pardus"><img src="'+tadres+'tubbar_03.jpg" onmouseout="outMouse(this)" onmouseover="onMouse(this)" \/><\/a><\/span><span><a href="http:\/\/www.iltaren.tubitak.gov.tr" title="TÜBİTAK UEKAE İLTAREN"><img src="'+tadres+'tubbar_05.jpg" onmouseout="outMouse(this)" onmouseover="onMouse(this)" \/><\/a><\/span><span><a href="http:\/\/www.bilgiguvenligi.gov.tr" title="Bilgi Güvenliği"><img src="'+tadres+'tubbar_06.jpg" onmouseout="outMouse(this)" onmouseover="onMouse(this)" \/><\/a><\/span><span><a href="http:\/\/www.ekds.gov.tr" title="Elektronik Kimlik Doğrulama Sistemi"><img src="'+tadres+'tubbar_07.jpg" onmouseout="outMouse(this)" onmouseover="onMouse(this)" \/><\/a><\/span>';
str+='                <\/div>';
str+='            <\/div>';
str+='        <\/div>';
str+='    <\/div>';
...
window.addEvent('domready', function(){
	var mySlides = [];
		...
		mySlides[0] = new Fx.Slide("tub-icerik");
		mySlides[0].hide();

		// ac // menuden acar kapar
 		$("tub-opener").addEvent('mouseenter', function(e){
			new Event(e).stop();
			mySlides[0].slideIn();
			return false;
		});
		
		// kapa // icerikden açar kapar
 		$("tub-icerik").addEvent('mouseleave', function(e){
			new Event(e).stop();
			mySlides[0].slideOut();
			return false;
		});
...
//boyut ayarı
$$(".tub-menuBack").each(function(elements){
	elements.style.width = tub_menu_genislik;
});

$$(".tub-menu").each(function(elements){
	elements.style.width = tub_opener_genislik;
});
	if(sagUstMenuGoster=="no"){
		$$(".tub-openerSag").each(function(elements){
			elements.style.visibility="hidden";
	});
}


$("tub-icerik-gizler").style.width=tub_opener_genislik;

function onMouse(element){
	elementName = new Array(2);
	elementName[0] = element.src.substr(0,element.src.lastIndexOf("."));
	elementName[1] = element.src.substr(element.src.lastIndexOf("."));
	element.src=elementName[0]+"_a"+elementName[1];
}

function outMouse(element){
	elementName = new Array(2);
	elementName[0] = element.src.substr(0,element.src.lastIndexOf(".")-2);
	elementName[1] = element.src.substr(element.src.lastIndexOf("."));
	element.src=elementName[0]+elementName[1];
}
